...
if(triangleOneArea === triangleTwoArea) {
    console.log("Nope, they are not similar");}

    else if(triangleOneArea > triangleTwoArea){
        console.log("The area of triangle ONE is bigger");
    }
    else{
        console.log ("Triangle TWO is the biggest area");
    }
...
if(triangleThreeArea === triangleFourArea) {
    ...
    console.log("triangle THRE is bigger then triangle FOUR");
}
else {
    console.log("triangle FOUR is the biggest one!");
}
...
console.log("triangle FIVE is bigger then triangle SIX");
}
else{
    console.log("triangle SIX is the biggest!");
}
